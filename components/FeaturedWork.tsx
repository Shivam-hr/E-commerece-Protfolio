...
export default function FeaturedWork() {
  return (
    <section id="work" className="px-8 lg:px-16 py-16 lg:py-2 text-center">
      <div className="inline-flex items-center gap-2 text-[16px] text-accent tracking-widest mb-4">
        <span className="w-1.5 h-1.5 rounded-full bg-accent inline-block" />
        FEATURED WORK
      </div>

      <h2 className="font-display font-semibold text-[38px] sm:text-[56px] text-ink mb-3">
        Digital Solutions.{" "}
      ...
      <div className="flex flex-wrap justify-center gap-2.5 mb-12">
        {filters.map((label, i) => (
          <button
            ...
            className={
              i === 0
                ? "bg-ink text-white text-sm font-medium px-5 py-2.5 rounded-btn"
